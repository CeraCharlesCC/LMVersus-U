...
internal object ConfigLoader {
    ...
    private fun showFirstRunMessage(configFile: File): Nothing {
        ...
        println("  - sessionCrypto.encryptionKeyHex      (32-hex-character (16-byte) key for session encryption)")
        println("  - sessionCrypto.signKeyHex            (64-hex-character (32-byte) key for session signing)")
        println()
